...
## Format using a data.frame | The Bos Rudis Way
...
```{r, echo=FALSE}
temp = pystr_format("The {name} gets {mpg} miles to the gallon and has {gear} gears.", cars)[, 1]
```

```{r, eval=FALSE}
pystr_format("The {name} gets {mpg} miles to the gallon and has {gear} gears.", cars)
```
...
<figure align="center">
<img src="figure/contributing.png" align="center"  width="100%" height="100%">
